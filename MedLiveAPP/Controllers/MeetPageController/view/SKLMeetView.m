...
- (void)setupUI{
    ...
    consultation_title.font = meet_title.font = live_title.font = join_title.font = [UIFont systemFontOfSize:12];
    consultation_title.textAlignment = meet_title.textAlignment = live_title.textAlignment = join_title.textAlignment = NSTextAlignmentCenter;
    ...
    NSArray<UIView *> *containorAry = @[containor_consultation,containor_meet,containor_live,containor_join];
